...
const columns = ref<TableColumn[]>([
	...
	},
	{
		...
		key: "size",
		width: 150,
		sorter: (a: RedisKey, b: RedisKey) => a.size - b.size,
	},
	{
		title: "TTL",
		dataIndex: "ttl",
  ...
  <div class="p-10px">
    <a-card>
      <div class="flex items-center justify-between flex-wrap gap-10px">
        <a-form layout="inline" class="flex-grow">
        ...
        <div class="ml-auto">
          共 {{ pagination.total }} 个键 | 当前数据库: DB {{ currentDb }}
        </div>
      </div>
    </a-card>
          ...
          <template v-if="column.dataIndex === 'operation'">
            <a-space>
              <a-tooltip title="查看详情">
                <a-button size="small" @click="showKeyDetail(record)">
                  <template #icon>
                    <eye-outlined />
                  </template>
                </a-button>
